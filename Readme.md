...
My professional experience includes roles as a Information Management Administrator - Snowflake at RGA, Data Analytics Engineer at SIUE, Graduate Assistant (Data Analyst) at SIUE and as a Senior Data Engineer at Tata Consultancy Services. In these roles, I've had the opportunity to lead the development of analytical dashboards and reports, conduct advanced statistical analyses, and craft compelling data visualizations using tools such as Snowflake, Microsoft Fabric, Microsoft Power BI, Tableau, Python, and SQL. I've also worked with cloud platforms like AWS and Azure, demonstrating my adaptability and proficiency in cloud computing.
